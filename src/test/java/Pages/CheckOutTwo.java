...
public class CheckOutTwo {
    ...
    By phone_mobile=By.xpath("//*[@id=\"phone_mobile\"]");
    By submitAccount=By.xpath("//*[@id=\"submitAccount\"]");
    By center_column= By.xpath("//*[@id=\"center_column\"]/form/p/button");
    By cgv= By.xpath("//*[@id=\"cgv\"]");
    By form= By.xpath("//*[@id=\"form\"]/p/button");
    By HOOK_PAYMENT= By.xpath("//*[@id=\"HOOK_PAYMENT\"]/div[1]/div/p/a");
    By cart_navigation= By.xpath("//*[@id=\"cart_navigation\"]/button");
    ...
    public void submit(String phone) {
        driver.findElement(phone_mobile).sendKeys(phone);
        driver.findElement(submitAccount).click();
    }
    public void confirm() {
        driver.findElement(center_column).click();
        driver.findElement(cgv).click();
        driver.findElement(form).click();

    }
    public void payment(){
        driver.findElement(HOOK_PAYMENT).click();

        driver.findElement(cart_navigation).click();
