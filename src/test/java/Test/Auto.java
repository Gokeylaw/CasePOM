    ...
    public static void main(String[] args) throws InterruptedException, AWTException {
      ...
      //  driver.findElement(By.xpath("//*[@id=\"center_column\"]/p[2]/a[1]")).click();
       ...
       //********************** PROCEED TO CHECKOUT CREATE ACCOUNT ACCEPT TERMS  AND CONDITIONS**********************************************************************************************//
        ...
        check.setEmail_create("testgoks"+i+"@gmail.com");
     ...
     /*   driver.findElement(By.xpath("//*[@id=\"phone_mobile\"]")).sendKeys("123456789");
        ...
        check.submit("123456789");
        Thread.sleep(2000);
        check.confirm();
        WebElement paymentmethod = driver.findElement(By.xpath(" //*[@id=\"HOOK_PAYMENT\"]/div[1]/div/p/a"));
        String p1 =paymentmethod.getAttribute("title");
        System.out.println(p1);
        WebElement paymentmethod2= driver.findElement(By.xpath("//*[@id=\"HOOK_PAYMENT\"]/div[2]/div/p/a"));
        String p2=paymentmethod2.getAttribute("title");
